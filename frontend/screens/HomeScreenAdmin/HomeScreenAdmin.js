    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.drawerContainer}>
          ...
          <TouchableOpacity>
            <Text style={styles.drawerMenuLinks}>Read Book Reviews</Text>
          </TouchableOpacity>

          <TouchableOpacity>
            <Text style={styles.drawerMenuLinks}>Publish A Review</Text>
          </TouchableOpacity>

          <TouchableOpacity>
            <Text style={styles.drawerMenuLinks}>Publish Notice</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={goToDonationInterests}>
            <Text style={styles.drawerMenuLinks}>Donation Interests</Text>
          </TouchableOpacity>

          <TouchableOpacity>
            <Text style={styles.drawerMenuLinks}>Donation History</Text>
          </TouchableOpacity>
